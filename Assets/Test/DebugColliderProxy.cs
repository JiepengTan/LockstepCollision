...
namespace Test {
    ...
    public class DebugColliderProxy : MonoBehaviour {
        ...
        private void Update(){
            ...
            if (diffPos || diffRot) {
                UpdateBoundBox(diffPos, diffRot, transform.position.ToLVector3(),
                    transform.forward.ToLVector3(),transform.up.ToLVector3());
                lastPosition = transform.position;
                lastRotation = transform.rotation;
            }
        }
        ...
        public void UpdateBoundBox(bool isDiffPos, bool isDiffRot, LVector3 targetPos, LVector3 forward, LVector3 up){
            if (isDiffPos) {
