...
namespace LockStepLMath
{
    public struct LQuaternion
    {
        ...
        public LVector eulerAngles
        {
            get
            {
                Matrix33 m = QuaternionToMatrix(this);
        ...
        /// <returns></returns>
        public static LQuaternion AngleAxis(LFloat angle, LVector axis)
        {
        ...
        /// <returns></returns>
        public static LQuaternion Euler(LVector euler)
        {
        ...
        /// <returns></returns>
        public static LQuaternion FromToRotation(LVector fromDirection, LVector toDirection)
        {
        ...
        /// <returns></returns>
        public static LQuaternion LookRotation(LVector forward)
        {
        ...
        /// <returns></returns>
        public static LQuaternion LookRotation(LVector forward, [DefaultValue("LVector.up")] LVector upwards)
        {
            Matrix33 m = LookRotationToMatrix(forward, upwards);
        ...
        /// <param name="fromDirection"></param>
        /// <param name="toDirection"></param>
        public void SetFromToRotation(LVector fromDirection, LVector toDirection)
        {
        ...
        public void SetLookRotation(LVector view) {
        ...
        /// <param name="view"></param>
        /// <param name="up"></param>
        public void SetLookRotation(LVector view, [DefaultValue("LVector.up")] LVector up) {
        ...
        /// <param name="angle"></param>
        /// <param name="axis"></param>
        public void ToAngleAxis(out LFloat angle, out LVector axis)
        {
            ...
            axis = new LVector(x * div, y * div, z * div);
        ...
        private LVector MatrixToEuler(Matrix33 m)
        {
        ...
        public static Matrix33 QuaternionToMatrix(LQuaternion quat)
        {
        ...
        private static LQuaternion MatrixToQuaternion(Matrix33 m)
        {
        ...
        private static Matrix33 LookRotationToMatrix(LVector viewVec, LVector upVec)
        {
            LVector z = viewVec;
            Matrix33 m = new Matrix33();
        ...
        public static LVector operator *(LQuaternion rotation, LVector point)
        {
